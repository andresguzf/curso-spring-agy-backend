...
- **Control de Acceso basado en Roles**:
  - `ROLE_USER`: Acceso de solo lectura a clientes (`GET /api/customers/**`).
  - `ROLE_ADMIN`: Acceso total para la gestión de clientes (Crear, Editar, Eliminar) y administración de usuarios.
